...
int main( int argc, char* argv[] )
{
 ...
 BMP Text;
 Text.ReadFromFile("src/EasyBMPtext.bmp");
  
 BMP Background;
 Background.ReadFromFile("src/EasyBMPbackground.bmp");
...
DrawLine(Background, 1, -2, 3, 4, TempColor);
cout << "Prueba de linea" << endl;
Output.WriteToFile( "DibujarMapa.bmp" );
