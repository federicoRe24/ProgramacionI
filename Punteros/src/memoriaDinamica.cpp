...
void ejemplo()
{
	...
	*q=8.1; // Ahora tenemos a r y q apuntando a dos direcciones distintas; una contiene 2.4 y la otra 8 .1
	...
	p= new int [20]; // Declaro un array dinámico --> Un vector que se genera en tiempo de ejecución.
	...
	delete [] p; // Luego de usarlo, liberamos el espacio de memoria que usó el array.
